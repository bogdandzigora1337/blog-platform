...
import "./SingUpSuccessfulRegNotification.module.scss";
...
const SingUpSuccessfulRegNotification: React.FC = () => {
  return (
    <div className={cl["success-notification"]}>
      <p>
        <span>{<IconSvg />}</span> Registration completed successfully <br />{" "}
        Login to your account <Link to="/sing-in">Sign In.</Link>
      </p>
    </div>
  );
};
